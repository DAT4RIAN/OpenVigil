...
import windops_backend.benchmarks.care.evaluation_artifact as _evaluation_artifact
...
COMPONENT_GENERALIZATION_PROTOCOL = _evaluation_artifact.COMPONENT_GENERALIZATION_PROTOCOL
EVALUATION_SUITE_PROTOCOL = _evaluation_artifact.EVALUATION_SUITE_PROTOCOL
EVALUATION_SUITE_SCHEMA_VERSION = _evaluation_artifact.EVALUATION_SUITE_SCHEMA_VERSION
OFFLINE_EVALUATION_VERSION = _evaluation_artifact.OFFLINE_EVALUATION_VERSION
CareOfflineEvaluationError = _evaluation_artifact.CareOfflineEvaluationError
EvaluationSuiteSpec = _evaluation_artifact.EvaluationSuiteSpec
_canonical_hash = _evaluation_artifact._canonical_hash
build_evaluation_suite_artifact = _evaluation_artifact.build_evaluation_suite_artifact
verify_evaluation_suite_artifact = _evaluation_artifact.verify_evaluation_suite_artifact
